...
namespace Fakultät
{
    internal class Program
    {
...

        {
            ...
            string geschlecht = string.Empty;

            {
...

                {
                    ...
                    {
                        Console.WriteLine("Tut mir leid Sie müssen ihr Geschlecht eingeben");
                    }
                ...
                Console.WriteLine(" ");
                Console.WriteLine("Noch ein kleiner Hinweis, zum Beenden exit eingeben");
                while (true)
                {
                    Console.WriteLine(" ");
